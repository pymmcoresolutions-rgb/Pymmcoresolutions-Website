  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white font-sans selection:bg-blue-500/30">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-[20%] -right-[10%] w-[30%] h-[50%] bg-amber-600/5 blur-[120px] rounded-full" />
        <div className="absolute -bottom-[10%] left-[20%] w-[50%] h-[30%] bg-teal-900/10 blur-[120px] rounded-full" />
      </div>
              ...
              {navItems.map(item => (
                <button
                  ...
                  className={`text-sm font-medium transition-all flex items-center gap-2 ${
                    currentPath === item.id ? 'text-teal-400' : 'text-white/50 hover:text-white'
                  }`}
                >
              ...
              {isEditor && (
                <button 
                  ...
                  className={`text-sm font-medium transition-all flex items-center gap-1 ${
                    currentPath === '#admin' ? 'text-teal-400' : 'text-teal-400/70 hover:text-teal-400'
                  }`}
                >
              ...
              {user ? (
                <div className="flex items-center gap-4 pl-4 border-l border-white/5">
                  ...
                  <div className="flex flex-col items-end">
                    ...
                    <span className="text-[10px] text-teal-400/60 uppercase tracking-widest font-black">{profile?.role || 'User'}</span>
                  </div>
                  <button 
                    onClick={() => logout()}
            ...
            <div className="flex flex-col gap-4">
              {navItems.map(item => (
                <button
                  ...
                  className={`flex items-center gap-4 p-5 rounded-2xl text-xl font-bold transition-all ${
                    currentPath === item.id ? 'bg-teal-700 text-white shadow-lg shadow-teal-900/20' : 'bg-white/5 text-white/40'
                  }`}
                >
              ...
              {isEditor && (
                <button
                  onClick={() => handleNavigate('#admin')}
                  className={`flex items-center gap-4 p-5 rounded-2xl text-xl font-bold transition-all ${
                    currentPath === '#admin' ? 'bg-teal-700 text-white' : 'bg-teal-700/10 text-teal-400'
                  }`}
                >
                ...
                <div className="flex items-center justify-between p-4 rounded-2xl bg-white/5 border border-white/10">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-[10px] text-teal-400/60 uppercase tracking-widest">{profile?.role}</div>
                    </div>
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li><button onClick={() => handleNavigate('#home')} className="text-sm text-white/40 hover:text-teal-400 transition-colors cursor-pointer">Home</button></li>
                <li><button onClick={() => handleNavigate('#')} className="text-sm text-white/40 hover:text-teal-400 transition-colors cursor-pointer">Storefront</button></li>
                <li><button onClick={() => handleNavigate('#advisor')} className="text-sm text-white/40 hover:text-teal-400 transition-colors cursor-pointer">AI Advisor</button></li>
                <li><button onClick={() => handleNavigate('#reviews')} className="text-sm text-white/40 hover:text-teal-400 transition-colors cursor-pointer">Reviews</button></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li><button onClick={() => handleNavigate('#privacy')} className="text-sm text-white/40 hover:text-teal-400 transition-colors cursor-pointer">Privacy Policy</button></li>
                <li><button onClick={() => handleNavigate('#terms')} className="text-sm text-white/40 hover:text-teal-400 transition-colors cursor-pointer">Terms of Use</button></li>
                <li><button onClick={() => handleNavigate('#security')} className="text-sm text-white/40 hover:text-teal-400 transition-colors cursor-pointer">Security Protocol</button></li>
                <li><button onClick={() => handleNavigate('#status')} className="text-sm text-white/40 hover:text-teal-400 transition-colors cursor-pointer">System Status</button></li>
              </ul>
            </div>
          </div>
