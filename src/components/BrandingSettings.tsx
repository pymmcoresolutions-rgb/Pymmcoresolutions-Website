...
import { Image as ImageIcon, Layers, Palette } from 'lucide-react';
...
export default function BrandingSettings() {
  ...
  return (
    <div className="space-y-8">
      <div className="flex bg-white/5 border border-white/10 rounded-2xl p-1.5 w-fit">
        <button
      ...
      >
        {activeTab === 'logo' ? <LogoManager /> : <BackgroundManager />}
      </motion.div>
    </div>
  );
}
